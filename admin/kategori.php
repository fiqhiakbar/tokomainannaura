      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Kategori Akuntansi</h3>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="kategori" required="required" class="form-control" placeholder="Nama Akun ..">
                      </div>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%">
                                    <label>Nama Akun</label>
                                    <input type="hidden" name="id" required="required" class="form-control" placeholder="Nama Akun .." value="<?php echo $d['kategori_id']; ?>">
                                    <input type="text" name="kategori" required="required" class="form-control" placeholder="Nama Akun .." value="<?php echo $d['kategori']; ?>" style="width:100%">
                                  </div>
