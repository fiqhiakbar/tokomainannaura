            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no = 1;
                  $data = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where kategori=transaksi_kategori order by transaksi_id desc");
                  while ($d = mysqli_fetch_array($data)) {
                  ?>
                    <tr>
                      <td class="text-center"><?php echo $no++; ?></td>
                      <td class="text-center"><?php echo date('d-m-Y', strtotime($d['transaksi_tanggal'])); ?></td>
                      <td><?php echo $d['transaksi_kategori']; ?></td>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <select name="kategori" style="width:100%" class="form-control" required="required">
                                      ...
                                      while ($k = mysqli_fetch_array($kategori)) {
                                      ?>
                                        <option <?php if ($d['transaksi_kategori'] == $k['kategori']) {
                                                  echo "selected='selected'";
                                                } ?> value="<?php echo $k['kategori']; ?>"><?php echo $k['kategori']; ?></option>
                                      <?php
                                      }
                                      ?>
                                    </select>
