...
if ($filename == "") {
	mysqli_query($koneksi, "insert into transaksi values ('','$tanggal','$jenis','$kategori','$nominal','$keterangan','','$bank')") or die(mysqli_error($koneksi));
	...
	if (!in_array($ext, $allowed)) {
		...
		mysqli_query($koneksi, "insert into transaksi values ('','$kategori','$tanggal','$jenis','$nominal','$keterangan','','$bank')");
		header("location:transaksi.php?alert=berhasil");
	}
}
